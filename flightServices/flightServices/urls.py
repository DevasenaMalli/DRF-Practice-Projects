...
urlpatterns = [
    ...
    path('flightServices/findFlights/',views.find_flights, name='find_flights'),
    path('flightServices/saveReservation/',views.save_reservation, name='save_reservation'),
    path('flightServices/findFlights/<int:id>/', views.find_flight_by_id, name='find_flight_by_id'),
